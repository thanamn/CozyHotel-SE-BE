...
describe('Accounts Controller', () => {
  ...
  describe('GET /api/v1/accounts', () => {
    ...
    it('should handle server error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error in getUsers:', error);
  ...
  describe('GET /api/v1/accounts/:id', () => {
    ...
    it('should handle server error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error in getUser:', error);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
        success: false,
        error: 'Server Error'
  ...
  describe('PUT /api/v1/accounts/:id', () => {
    ...
    it('should handle server error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error in updateUser:', error);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
        success: false,
        error: 'Server Error'
  ...
  describe('DELETE /api/v1/accounts/:id', () => {
    ...
    it('should handle server error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error in deleteUser:', error);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({
        success: false,
        error: 'Server Error'
